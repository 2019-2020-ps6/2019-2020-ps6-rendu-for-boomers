 ...
 // }
  ...
  updateContrast(value: number): void {
    ...
    if(value == 1){
      ...
      document.documentElement.style.setProperty("--main-panel-color", "lightgray");
      document.documentElement.style.setProperty("--main-panel-color-light", "white");
      document.documentElement.style.setProperty("--alt-panel-color", "#e0e0e0");
      document.documentElement.style.setProperty("--main-shadow-color", "lightgray");
    }
    if(value == 2){
